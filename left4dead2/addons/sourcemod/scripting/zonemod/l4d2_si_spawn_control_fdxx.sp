...
public void OnPluginStart()
{
	...
	g_cvSpecialLimit[HUNTER] =	CreateConVar("l4d_infectedbots_hunter_limit",	"1", "Hunter limit.", FCVAR_NONE, true, 0.0, true, 32.0);
	g_cvSpecialLimit[JOCKEY] =	CreateConVar("l4d_infectedbots_jockey_limit",	"1", "Jockey limit.", FCVAR_NONE, true, 0.0, true, 32.0);
	g_cvSpecialLimit[SMOKER] =	CreateConVar("l4d_infectedbots_smoker_limit",	"1", "Smoker limit.", FCVAR_NONE, true, 0.0, true, 32.0);
	g_cvSpecialLimit[BOOMER] =	CreateConVar("l4d_infectedbots_boomer_limit",	"1", "Boomer limit.", FCVAR_NONE, true, 0.0, true, 32.0);
	g_cvSpecialLimit[SPITTER] = CreateConVar("l4d_infectedbots_spitter_limit",	"1", "Spitter limit.", FCVAR_NONE, true, 0.0, true, 32.0);
	g_cvSpecialLimit[CHARGER] =	CreateConVar("l4d_infectedbots_charger_limit",	"1", "Charger limit.", FCVAR_NONE, true, 0.0, true, 32.0);

	g_cvMaxSILimit =		CreateConVar("l4d_infectedbots_max_specials",			"8",	"Max SI limit.", FCVAR_NONE, true, 0.0, true, 32.0);
	g_cvSpawnTime =			CreateConVar("l4d_infectedbots_spawn_time_max",			"1.0",	"SI spawn time.", FCVAR_NONE, true, 1.0);
